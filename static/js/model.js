...
async function fetchEntries(clear) {
    ...
    data.forEach(modelRecord => {
        ...
        editBtn.append($('<img>')
            .attr("src", `https://cdn.jsdelivr.net/gh/ahmedsaleh747/go-creative-utils@v0.1.29/static/images/edit.png`)
            .attr("alt", "Edit")
        ...
        deleteBtn.append($('<img>')
            .attr("src", `https://cdn.jsdelivr.net/gh/ahmedsaleh747/go-creative-utils@v0.1.29/static/images/delete.png`)
            .attr("alt", "Delete")
            .attr("style", "width: 24px; height: 24px")
        )
