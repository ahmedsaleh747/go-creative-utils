...
-> Search for v0.1.35 version in the utils and update it
-> Commit the code
git tag v0.1.35
git push origin v0.1.35
-> Then update the dependancies in the child projects, by searching for: utils@v0.1.35 (-1 [the old version])
-> Then download the new version: go get -u github.com/ahmedsaleh747/go-creative-utils@v0.1.35
